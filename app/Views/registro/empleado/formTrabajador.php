...
<h5 class="modal-title w-100 text-center" style="color: #36907A"><b>Formulario para registrar un nuevo empleado</b></h5>
<p><br></p>
<form method="POST" action="<?=Base_url('dataFormTra')?>" >
  <div class="form-row">
